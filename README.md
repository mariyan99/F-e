...
**Зависимостите са замразени до пускането.** Само security patch с доказан CVE.

## Документация

| Документ | Съдържание |
|---|---|
| [agent-handoff](docs/agent-handoff.md) | **Каналът Claude ↔ Codex.** Текущо състояние, задача към Codex, какво иска собственика |
| [05 · ADR-001](docs/plan/05-architecture-decision.md) | приетите технологии и решенията O-1…O-10 с последиците им |
| [14 · Визуална посока](docs/plan/14-design-direction.md) | стандартът за UI качество: какво прави разликата, какво е забранено, как се мери |
| [11 · Пускане на домейна](docs/plan/11-main-domain-launch.md) | преработеният график, миграцията на каталога, рискът със снимките |
| [13 · Находки от стария сайт](docs/plan/13-legacy-findings.md) | валута, правило за спрян продукт, съотношения на снимките, дефекти от първия пуск |
| [06 · MVP обхват](docs/plan/06-mvp-scope-softlaunch.md) | какво влиза, какво не, какво е опасно да се бута преди пускане |
...
| [tools/legacy](tools/legacy/README.md) | **Започни оттук.** Един скрипт, който изважда целия безопасен `/legacy` пакет |
| [12 · Какво да качиш в /legacy](docs/plan/12-legacy-upload-instructions.md) | ръчният вариант: минимумът, какво да НЕ качваш, проверка за секрети |
| [09 · Стар сайт](docs/plan/09-legacy-prep-checklist.md) | пълните команди зад документ 12 |
| [infra/deploy](infra/deploy/README.md) | деплой с два пътя: Docker или systemd/PM2 |
